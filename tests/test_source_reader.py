...
class SourceTranscriptReaderTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.path = root / (
            "rollout-2026-08-11T10-00-00-00000000-0000-4000-8000-000000000106.jsonl"
        )
        ...
        self.session_id = "codex:00000000-0000-4000-8000-000000000106"
        self.conn.execute(
            """
            INSERT INTO sessions
              (id, harness, external_id, artifact_id, transcript_storage)
            VALUES (?, 'codex', '00000000-0000-4000-8000-000000000106', ?, 'source_backed')
            """,
