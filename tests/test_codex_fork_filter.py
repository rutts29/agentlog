...
PARENT_ID = "00000000-0000-4000-8000-000000000110"
CHILD_ID = "00000000-0000-4000-8000-000000000111"
LOCAL_TURN_ID = "00000000-0000-4000-8000-000000000112"
...
class CodexForkFilterTests(unittest.TestCase):
        ...
        return b"".join(
            [
                ...
                _line(
                    ...
                    {
                        "type": "task_started",
                        "turn_id": "00000000-0000-4000-8000-000000000117",
    ...
    def test_t3_full_history_worker_keeps_only_local_runtime_and_brief(self) -> None:
        parent_id = "00000000-0000-4000-8000-000000000107"
        worker_id = "00000000-0000-4000-8000-000000000115"
        parent_turn = "00000000-0000-4000-8000-000000000114"
        worker_turn = "00000000-0000-4000-8000-000000000116"
    ...
    def test_later_local_human_turn_is_not_trimmed(self) -> None:
        second_turn = "00000000-0000-4000-8000-000000000113"
    ...
    def test_native_guardian_without_trigger_metadata_is_entirely_local(self) -> None:
        native_id = "00000000-0000-4000-8000-000000000101"
