...
class InsightsFeedTests(unittest.TestCase):
    ...
    def test_imported_session_fact_hydrates_exact_source_backed_message(self) -> None:
        external_id = "00000000-0000-4000-8000-000000000106"
    ...
    def test_approved_session_fact_keeps_full_body(self) -> None:
        ...
        self.conn.execute(
            ...
            """,
            (session_id, "Coordinate the review and leave implementation to the assigned developer."),
        )
                    ...
                    "items": [
                        {
                            ...
                            "message_seq": 1,
                            "kind": "how_you_run",
                            "title": "Keep review and implementation roles separate",
                            "body": long_body,
                            "quote": "Coordinate the review and leave implementation to the assigned developer.",
                            "does_not_prove": "This does not establish a preference outside this review.",
                        }
                    ],
                }
            ),
